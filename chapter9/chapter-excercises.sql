...
FROM 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter9\MPI_Directory_by_Establishment_Name.csv'
...
COPY state_regions
FROM 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter9\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
