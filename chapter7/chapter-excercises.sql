...
INSERT INTO natural_key_example (license_id, first_name, last_name)
VALUES ('T229903', 'bob', 'jon');

SELECT * FROM natural_key_example;

-- this will not insert because the license key must be unique.
INSERT INTO natural_key_example (license_id, first_name, last_name)
...
INSERT INTO natural_key_composite_example (student_id, school_day, present)
VALUES(776, '1/23/2017', 'Y');

INSERT INTO natural_key_composite_example (student_id, school_day, present)
VALUES(777, '1/23/2017', 'N');
...
FROM 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter7\city_of_new_york.csv'
