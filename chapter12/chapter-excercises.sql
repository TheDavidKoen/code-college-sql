...
FROM 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter12\ice_cream_survey.csv'
...
FROM 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter12\temperature_readings.csv'
WITH (FORMAT CSV, HEADER);
