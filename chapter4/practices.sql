...
FROM 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter4\us_counties_2010.csv'
...
FROM 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter4\supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER);
...
COPY us_counties_2010
TO 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter4\us_counties_export.txt'
...
TO 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter4\us_counties_latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
TO 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter4\us_counties_mill_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');