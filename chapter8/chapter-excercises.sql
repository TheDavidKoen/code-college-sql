...
FROM 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter8\pls_fy2014_pupld14a.csv'
...
FROM 'C:\01-my-folder\Work\code-college\my_code\software\sql\chapter8\pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER);
